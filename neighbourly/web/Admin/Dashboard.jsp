<%-- 
    Document   : Report
    Created on : Dec 23, 2024, 9:23:13 AM
    Author     : Dean Ardley
--%>

<%@page contentType="text/html" pageEncoding="UTF-8" import="java.sql.*, java.util.*, javax.servlet.http.*, javax.servlet.annotation.*"%>
...
<%
    if(request.getMethod().equals("post")){
        ...
        // Check if the form submission is a multipart request
        if (request.getContentType() != null && request.getContentType().startsWith("multipart/form-data")) {
            Part filePart = request.getPart("attachment"); // Retrieve the file part by its name
        ...
        // Handle double quotes in location (using PreparedStatement)
        location = location.replace("\"", "\\\""); 
        
        try{
            
            Connection conn = DriverManager.getConnection("jdbc:derby://localhost:1527/neighborly", "app", "app");
            PreparedStatement stmt = conn.prepareStatement("INSERT INTO report (userID, dataOfVisit, location, remarks, attachment) VALUES (?, ?, ?, ?, ?)");
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="py-3 mb-4"><span class="text-muted fw-light">Report Form</h4>
                    ...
                    <div class="col-xl">
                        <div class="card mb-4">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5 class="mb-0">Enter Report Information</h5>
                                <small class="text-muted float-end">Default label</small>
                            </div>
                        <div class="card-body">
                            <form action="Report.jsp" method="post" multipart="enctype/form-data">                         
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="remarks" id="basic-default-message"
