...
url="jdbc:derby://localhost:1527/neighborly" user="app" password="app"/>
...
<%
    if(request.getMethod().equals("POST")){
        ...
        try{
            ...
            PreparedStatement stmt = conn.prepareStatement("INSERT INTO visitor (userID, visitor_name, visitor_ic, no_plate, entryTime, exitTime, dateOfVisit, purposeOfVisit, visitor_phonenum) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            ...
            <a href="Dashboard.jsp" class="layout-menu-toggle menu-link text-large ms-auto">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="py-3 mb-4"><span class="text-muted fw-light">Visitor Form</h4>
                    ...
                    <div class="col-xl">
                        <div class="card mb-4">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5 class="mb-0">Enter Visitor Information</h5>
                            ...
                            <div class="card-body">
                                <form action="Visitor.jsp" method="post">                       
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="basic-default-fullname" name="visitorName" placeholder="Enter visitor name">
                                    </div>
                                    
                                    <div class="mb-3">
                                        <label class="form-label">IC Number:</label>
                                        <input type="text" class="form-control" id="basic-default-fullname" name="visitorIC" placeholder="Enter IC number">
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label">Plate Number:</label>
                                        <input type="text" class="form-control" id="basic-default-fullname" name="plateNumber" placeholder="Enter plate number">
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label">Entry Time:</label>
                                        <input type="time" class="form-control" id="basic-default-fullname" name="entryTime">
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label">Exit Time:</label>
                                        <input type="time" class="form-control" id="basic-default-fullname" name="exitTime">
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label">Date of Visit:</label>
                                        <input type="date" class="form-control" id="basic-default-fullname" name="visitDate">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        class="form-control"
                                        placeholder="Hi, Do you have a moment to talk Gaeul?"></textarea>
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label">Phone Number:</label>
                                        <input type="tel" class="form-control" id="basic-default-fullname" placeholder="Enter phone number" name="phoneNumber">
                                    </div>
                ...
                <div class="card">
                    <h5 class="card-header">List of Visitors</h5>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="updateVisitor.jsp?registerID=<%= registerID %>">
