        ...
        <div class="layout-page">
         ...
         <div class="content-wrapper">
           ...
           <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="col-12">
              <div class="card mb-4">
                <h5 class="card-header">Complaints Form</h5>
                <div class="card-body">
                  <div class="mb-3">
                ...
                <div class="col-12">
                  <div class="card mb-4">
                <div class="card">
                <h5 class="card-header">Complaints Status</h5>
                <div class="table-responsive text-nowrap">
                <table class="table">
                <thead>
                  <tr>
                    <th>Complaints Type</th>
                    <th>Complaints Desc</th>
                    <th>Date</th>
                    <th>Status</th>
                    <th>Location</th>
                  </tr>
                ...
                <tbody class="table-border-bottom-0">
                  <tr>
                    ...
                    <td>Jalan Anggerik 03</td>
                  </tr>
                  <tr>
                    <td>
                      <span class="fw-medium">Noise</span>
                    </td>
                    <td>Motocycle Noise at night</td>
                    <td>23-10-2024</td>
                    <td><span class="badge bg-label-warning me-1">Pending</span></td>
                    <td>Jalan Anggerik 14</td><br>
                  </tr>
