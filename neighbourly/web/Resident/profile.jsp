                    ...
                    <div class="card-body">
                      <ul class="col-md-6 mb-1">
                        <li class="d-flex align-items-center mb-3">
                          ...
                          ><span class="fw-medium mx-2 text-heading">Username:</span> <span>Siti Soleha</span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                          <i class="ti ti-check text-heading"></i
                          ><span class="fw-medium mx-2 text-heading">Full Name:</span> <span>Siti Soleha binti Salehuddin</span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                          <i class="ti ti-crown text-heading"></i
                          ><span class="fw-medium mx-2 text-heading">IC Number:</span> <span>658412-19-6325</span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                          <i class="ti ti-flag text-heading"></i
                          ><span class="fw-medium mx-2 text-heading">Address:</span> <span>No.32, Jalan anggerik, Taman Jaya.</span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                          <i class="ti ti-phone-call"></i><span class="fw-medium mx-2 text-heading">Contact:</span>
                          <span>012 - 2365 8741</span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                          <i class="ti ti-mail"></i><span class="fw-medium mx-2 text-heading">Email:</span>
                          <span>solehasiti@example.com</span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                          <i class="ti ti-brand-skype"></i><span class="fw-medium mx-2 text-heading">Vehicle Number Plate:</span>
                          <span>BMN584</span>
                        </li>
                      </ul>
                    </div>
