          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
              <form id="formAccountSettings" method="GET" onsubmit="return false">
                ...
                <div class="mt-2">
                  <a href="profile.html" class="btn btn-primary me-2">Save changes</a>
                  <button type="reset" class="btn btn-label-secondary"onclick="window.location.href='profile.html'">Cancel</button>
                </div>
              </form>
            </div>
            <!-- / Content -->
